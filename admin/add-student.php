<?php 
  ...
  if (isset($_POST['addstudent'])) {
    ...
    $query = "INSERT INTO `student_info`(`name`, `roll`, `class`, `city`, `pcontact`, `carrera`, `photo`) VALUES ('$name', '$roll', '$class', '$address', '$pcontact', '$carrera', '$photo');";
...
<div class="form-group">
<label for="carrera">Carrera Estudiantil</label>
